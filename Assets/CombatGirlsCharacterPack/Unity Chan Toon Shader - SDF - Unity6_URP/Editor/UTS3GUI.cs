...
namespace UnityEditor.Rendering.Toon {
    internal partial class UTS3GUI : UnityEditor.ShaderGUI {
        ...
        internal const string ShaderPropUseSDFShadow = "_UseSDFShadow";
        internal const string ShaderPropFaceShadowMap = "_FaceShadowMap";
        internal const string ShaderPropFaceShadowMaskMap = "_FaceShadowMaskMap";
        internal const string ShaderPropFaceShadowMaskStrength = "_FaceShadowMaskStrength";
        internal const string ShaderPropFaceShadowOffset = "_FaceShadowOffset";
        internal const string ShaderPropFaceShadowSoftness = "_FaceShadowSoftness";
        internal const string ShaderPropFaceForward = "_FaceForward";
        internal const string ShaderPropFaceRight = "_FaceRight";
        internal const string ShaderPropUseScriptVectors = "_UseScriptVectors";
        internal const string ShaderPropMirrorFaceShadowByLight = "_MirrorFaceShadowByLight";
        internal const string ShaderPropFaceShadowMirrorBlend = "_FaceShadowMirrorBlend";
        internal const string ShaderPropSDFFrontShadowSuppressStart = "_SDFFrontShadowSuppressStart";
        internal const string ShaderPropSDFFrontShadowSuppressEnd = "_SDFFrontShadowSuppressEnd";
        internal const string ShaderPropSDFDebugMode = "_SDFDebugMode";
        ...
        protected bool _FaceSDFShadow_Foldout = false;
        ...
        protected MaterialProperty useSDFShadow = null;
        protected MaterialProperty faceShadowMap = null;
        protected MaterialProperty faceShadowMaskMap = null;
        protected MaterialProperty faceForward = null;
        protected MaterialProperty faceRight = null;
        protected MaterialProperty sdfDebugMode = null;
        ...
        void FindProperties(MaterialProperty[] props) {
            ...
            useSDFShadow = FindProperty(ShaderPropUseSDFShadow, props, false);
            faceShadowMap = FindProperty(ShaderPropFaceShadowMap, props, false);
            faceShadowMaskMap = FindProperty(ShaderPropFaceShadowMaskMap, props, false);
            faceForward = FindProperty(ShaderPropFaceForward, props, false);
            faceRight = FindProperty(ShaderPropFaceRight, props, false);
            sdfDebugMode = FindProperty(ShaderPropSDFDebugMode, props, false);
...
//----------------------------------------------------------------------------------------------------------------------
        ...
        private static class Styles {
            ...
            public static readonly GUIContent faceSDFShadowFoldout =
                EditorGUIUtility.TrTextContent("Face SDF Shadow Settings", "Face SDF shadow settings for character face shading.");
            ...
            public static readonly GUIContent faceShadowMapText =
                new GUIContent("Face Shadow Map (SDF)", "SDF texture used to control face shadow shape.");

            public static readonly GUIContent faceShadowMaskMapText =
                new GUIContent("Face Fixed Shadow Map", "Fixed face shadow mask added to the SDF shadow.");
...
// ----------------------------------------------------- for GUI Toggles
            ...
            public static readonly GUIContent useSDFShadowText = new GUIContent("Use SDF Face Shadow", "Enable SDF-based face shadowing.");
            public static readonly GUIContent useScriptVectorsText =
                new GUIContent("Use Script Vectors", "Use _FaceForward and _FaceRight values supplied by script instead of object-space light direction.");
            public static readonly GUIContent mirrorFaceShadowByLightText =
                new GUIContent("Mirror Face Shadow By Light Side", "Mirror the SDF lookup according to the horizontal light direction.");
            public static readonly GUIContent faceForwardText = new GUIContent("Face Forward", "World-space face forward vector supplied by script.");
            public static readonly GUIContent faceRightText = new GUIContent("Face Right", "World-space face right vector supplied by script.");
            public static readonly GUIContent sdfDebugModeText = new GUIContent("SDF Debug Mode", "Debug display for SDF face shadow values.");
            ...
            public static readonly RangeProperty faceShadowMaskStrengthText = new RangeProperty(
                label: "Face Fixed Shadow Strength", tooltip: "Controls the strength of the fixed face shadow mask.",
                propName: ShaderPropFaceShadowMaskStrength, defaultValue: 1.0f, min: 0.0f, max: 1.0f);

            public static readonly RangeProperty faceShadowOffsetText = new RangeProperty(
                label: "Face Shadow Offset", tooltip: "Offsets the SDF threshold used to place the face shadow.",
                propName: ShaderPropFaceShadowOffset, defaultValue: 0.0f, min: -1.0f, max: 1.0f);

            public static readonly RangeProperty faceShadowSoftnessText = new RangeProperty(
                label: "Face Shadow Softness", tooltip: "Softens the SDF shadow boundary.",
                propName: ShaderPropFaceShadowSoftness, defaultValue: 0.02f, min: 0.0001f, max: 0.5f);

            public static readonly RangeProperty faceShadowMirrorBlendText = new RangeProperty(
                label: "Face Shadow Mirror Blend", tooltip: "Controls how softly the SDF mirror switches by light side.",
                propName: ShaderPropFaceShadowMirrorBlend, defaultValue: 0.08f, min: 0.001f, max: 0.5f);

            public static readonly RangeProperty sdfFrontShadowSuppressStartText = new RangeProperty(
                label: "Front Suppress Start", tooltip: "Starts suppressing SDF shadow when the light faces the character front.",
                propName: ShaderPropSDFFrontShadowSuppressStart, defaultValue: 0.65f, min: -1.0f, max: 1.0f);

            public static readonly RangeProperty sdfFrontShadowSuppressEndText = new RangeProperty(
                label: "Front Suppress End", tooltip: "Ends suppressing SDF shadow when the light faces the character front.",
                propName: ShaderPropSDFFrontShadowSuppressEnd, defaultValue: 0.9f, min: -1.0f, max: 1.0f);
...
//- --------------------------------------------------------------------------------------------------------------------
        ...
        void GUI_BasicThreeColors(Material material) {
            ...
            if (useSDFShadow != null && material.HasProperty(ShaderPropUseSDFShadow)) {
                _FaceSDFShadow_Foldout = FoldoutSubMenu(_FaceSDFShadow_Foldout, Styles.faceSDFShadowFoldout);
                if (_FaceSDFShadow_Foldout) {
                    EditorGUI.indentLevel++;
                    GUI_FaceSDFShadow(material);
                    EditorGUI.indentLevel--;
                    EditorGUILayout.Space();
                }
            }
        ...
        void GUI_FaceSDFShadow(Material material) {
            if (useSDFShadow == null || !material.HasProperty(ShaderPropUseSDFShadow)) {
                return;
            }

            bool isEnabled = GUI_Toggle(material, Styles.useSDFShadowText, ShaderPropUseSDFShadow,
                MaterialGetInt(material, ShaderPropUseSDFShadow) != 0);
            ...
            if (faceShadowMap != null) {
                m_MaterialEditor.TexturePropertySingleLine(Styles.faceShadowMapText, faceShadowMap);
            }

            if (faceShadowMaskMap != null) {
                m_MaterialEditor.TexturePropertySingleLine(Styles.faceShadowMaskMapText, faceShadowMaskMap);
            }

            GUI_RangeProperty(material, Styles.faceShadowMaskStrengthText);
            GUI_RangeProperty(material, Styles.faceShadowOffsetText);
            GUI_RangeProperty(material, Styles.faceShadowSoftnessText);

            bool useScriptVectorsEnabled = GUI_Toggle(material, Styles.useScriptVectorsText, ShaderPropUseScriptVectors,
                MaterialGetInt(material, ShaderPropUseScriptVectors) != 0);

            if (useScriptVectorsEnabled) {
                EditorGUI.indentLevel++;
                if (faceForward != null) {
                    m_MaterialEditor.VectorProperty(faceForward, Styles.faceForwardText.text);
                }

                if (faceRight != null) {
                    m_MaterialEditor.VectorProperty(faceRight, Styles.faceRightText.text);
                }

                EditorGUI.indentLevel--;
            }

            GUI_Toggle(material, Styles.mirrorFaceShadowByLightText, ShaderPropMirrorFaceShadowByLight,
                MaterialGetInt(material, ShaderPropMirrorFaceShadowByLight) != 0);
            GUI_RangeProperty(material, Styles.faceShadowMirrorBlendText);
            GUI_RangeProperty(material, Styles.sdfFrontShadowSuppressStartText);
            GUI_RangeProperty(material, Styles.sdfFrontShadowSuppressEndText);

            if (sdfDebugMode != null) {
                m_MaterialEditor.ShaderProperty(sdfDebugMode, Styles.sdfDebugModeText);
            }
